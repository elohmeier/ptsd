...
let
  ...
  paperless-web =
    ...
    pkgs.writeShellScriptBin "paperless-web" ''
      ...
      export PAPERLESS_OCR_SKIP_ARCHIVE_FILE="${env.PAPERLESS_OCR_SKIP_ARCHIVE_FILE}"
      export PAPERLESS_CONSUMER_ENABLE_BARCODES="${env.PAPERLESS_CONSUMER_ENABLE_BARCODES}"
      export PAPERLESS_CONSUMER_ENABLE_ASN_BARCODE="${env.PAPERLESS_CONSUMER_ENABLE_ASN_BARCODE}"
      export PAPERLESS_CONSUMER_BARCODE_SCANNER="${env.PAPERLESS_CONSUMER_BARCODE_SCANNER}"
