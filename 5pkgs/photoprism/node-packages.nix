...
let
  sources = {
    ...
    "@vvo/tzdb-6.50.0" = {
      ...
      version = "6.50.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@vvo/tzdb/-/tzdb-6.50.0.tgz";
        sha512 = "Qhz+bCCIO8OhriKIhCJ4EHYRiZliY1gmitIxcxgFO4VGOujKG5WWQUs6ecIXBbF0YRYnkbG97TTE6A8uu2f8cg==";
      };
    };
    ...
    "cssnano-5.1.9" = {
      ...
      version = "5.1.9";
      src = fetchurl {
        url = "https://registry.npmjs.org/cssnano/-/cssnano-5.1.9.tgz";
        sha512 = "hctQHIIeDrfMjq0bQhoVmRVaSeNNOGxkvkKVOcKpJzLr09wlRrZWH4GaYudp0aszpW8wJeaO5/yBmID9n7DNCg==";
      };
    };
    "cssnano-preset-default-5.2.9" = {
      ...
      version = "5.2.9";
      src = fetchurl {
        url = "https://registry.npmjs.org/cssnano-preset-default/-/cssnano-preset-default-5.2.9.tgz";
        sha512 = "/4qcQcAfFEg+gnXE5NxKmYJ9JcT+8S5SDuJCLYMDN8sM/ymZ+lgLXq5+ohx/7V2brUCkgW2OaoCzOdAN0zvhGw==";
      };
    };
    "cssnano-utils-3.1.0" = {
      name = "cssnano-utils";
    ...
    "eslint-plugin-n-15.2.0" = {
      ...
      version = "15.2.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/eslint-plugin-n/-/eslint-plugin-n-15.2.0.tgz";
        sha512 = "lWLg++jGwC88GDGGBX3CMkk0GIWq0y41aH51lavWApOKcMQcYoL3Ayd0lEdtD3SnQtR+3qBvWQS3qGbR2BxRWg==";
      };
    };
    ...
    "eslint-plugin-vue-9.0.1" = {
      ...
      version = "9.0.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/eslint-plugin-vue/-/eslint-plugin-vue-9.0.1.tgz";
    ...
    "flow-remove-types-2.179.0" = {
      ...
      version = "2.179.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/flow-remove-types/-/flow-remove-types-2.179.0.tgz";
        sha512 = "eO2htmhjfKOaG5n8isQVVHrgxuS15TMgKkTQPnaAc1UaPCgv+pMnOlSQEhm7qlEuZEHycMAEFNvlQExYhVNOUw==";
      };
    };
    ...
    "postcss-convert-values-5.1.1" = {
      ...
      version = "5.1.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/postcss-convert-values/-/postcss-convert-values-5.1.1.tgz";
        sha512 = "UjcYfl3wJJdcabGKk8lgetPvhi1Et7VDc3sYr9EyhNBeB00YD4vHgPBp+oMVoG/dDWCc6ASbmzPNV6jADTwh8Q==";
      };
    };
    ...
    "postcss-loader-7.0.0" = {
      ...
      version = "7.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/postcss-loader/-/postcss-loader-7.0.0.tgz";
        sha512 = "IDyttebFzTSY6DI24KuHUcBjbAev1i+RyICoPEWcAstZsj03r533uMXtDn506l6/wlsRYiS5XBdx7TpccCsyUg==";
      };
    };
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."cssnano-5.1.9"
      sources."cssnano-preset-default-5.2.9"
      ...
      sources."eslint-plugin-n-15.2.0"
      ...
      (sources."eslint-plugin-vue-9.0.1" // {
        dependencies = [
          sources."lru-cache-6.0.0"
          sources."semver-7.3.7"
        ];
      ...
      (sources."flow-remove-types-2.179.0" // {
        dependencies = [
      ...
      sources."postcss-convert-values-5.1.1"
