...
in
{
  ...
  home-manager.users.mainUser = { pkgs, ... }: {
    wayland.windowManager.sway = {
      extraConfig = ''
        output "Goldstar Company Ltd LG UltraFine 701NTAB7S144" pos 0 0 mode 4096x2304@59.999Hz scale 1
        output "Dell Inc. DELL P2415Q D8VXF96K09HB" pos 0 2304 mode 3840x2160@59.997Hz scale 1
        output "Dell Inc. DELL P2415Q D8VXF64G0LGL" pos 3840 2304 mode 3840x2160@59.997Hz scale 1
      '';
    };
