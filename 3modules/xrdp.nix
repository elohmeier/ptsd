# copy of the original module at https://github.com/NixOS/nixpkgs/blob/323e8ef37549c2cff1412c384858fc6e78d64c1c/nixos/modules/services/networking/xrdp.nix
# changes:
# - rename to ptsd
# - disable MIT-SHM and XTEST extension in sesman.ini to enable Citrix Receiver
